...
<template>
  <nav class="bg-black text-white py-2">
    <div class="container flex justify-between items-center mx-auto">
      <address class="space-x-2">
        <span>NG</span>
        <a href="mailto:oodulaja23@gmail.com" class="hover:underline transition-all duration-75"
          >oodulaja23@gmail.com</a
        >
        <a href="tel:+234811XXXXXXX" class="hover:underline transition-all duration-75"
          >+234811XXXXXXX</a
        >
      </address>
      <div>
        <button class="hover:underline transition-all duration-75 mr-5 font-semibold">
          Sign in
        </button>
        <button class="hover:underline transition-all duration-75 font-semibold">
          Create account
        </button>
      </div>
    </div>
